...
package br.pucrio.inf.lac.mhub.helpers;
...
public class MultiMap<K, V> {
    /** Used to handle concurrency instead of the normal HashMap */
    private final ConcurrentHashMap<K, List<V>> mInternalMap;
    ...
    /**
     * Checks if the InternalMap is empty
     */
    ...
    public Map<String, V> getUniqueMap() {
        Map<String, V> uniqueMap = new HashMap<>();
     ...
     *
     * @param uniqueMap Map structure
     * @param proposedKey Key
