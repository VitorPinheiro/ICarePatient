...
public class HXM021144_HeartBeatNumSensor extends HXM021144_AbstractSensor {

    private static HXM021144_HeartBeatNumSensor instance;

    private HXM021144_HeartBeatNumSensor() {
        super();
    }

    public static HXM021144_HeartBeatNumSensor getInstance() {
        if (instance == null) {
            instance = new HXM021144_HeartBeatNumSensor();
        }
        return instance;
    }
