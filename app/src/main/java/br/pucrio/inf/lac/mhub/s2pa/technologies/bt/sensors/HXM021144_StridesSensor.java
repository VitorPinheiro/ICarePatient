...
public class HXM021144_StridesSensor extends HXM021144_AbstractSensor {

    private static HXM021144_StridesSensor instance;

    private HXM021144_StridesSensor() {
        super();
    }

    public static HXM021144_StridesSensor getInstance() {
        if (instance == null) {
            instance = new HXM021144_StridesSensor();
        }
        return instance;
    }
